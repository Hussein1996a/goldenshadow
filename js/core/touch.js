...
const TouchControls = {
  ...
  bindJoystick() {
    ...
    const start = (e) => {
      ...
      // scale the drag radius off the joystick's actual on-screen size, so
      // it feels consistent across phone widths instead of a fixed 40px
      this.joyMaxR = rect.width * 0.32;
      e.preventDefault();
    };
    const move = (e) => {
